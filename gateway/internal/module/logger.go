...
func NewLogger(cfg *config.Config, lp *sdklog.LoggerProvider) (*zap.Logger, error) {
	...
	// Add OTLP core if log provider is available
	if lp != nil {
	...
	l := zap.New(combinedCore, zap.AddCaller())
